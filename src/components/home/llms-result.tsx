...
export function LlmsResult({ url, llmsTxt, pagesFound, elapsed, onRecrawl }: LlmsResultProps) {
        ...
        <CardContent>
          <Tabs defaultValue="preview">
            ...
            <TabsContent value="preview">
              <div className="prose prose-sm dark:prose-invert max-w-none rounded-md border bg-muted/30 p-6">
                {text.split("\n").map((line, i) => {
                  if (line.startsWith("# "))
